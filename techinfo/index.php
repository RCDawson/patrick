...
<script>
      $(document).ready(function() {
       	$('.nested > b').each(function() {
       		$(this).append('<em>').css('cursor','pointer');
       		var fileCount = $('em',this).text(' ('+ $(this).parent().find('li').length + ' Files)');
       	});
    ...
    <div id="bcopy">
      ...
      <br />
          ...
          <h2>GE/Multilin</h2>
            ...
            <p>
           	<ul>
                	<li><a href="http://www.utilityrelay.com/TripCalcProg.htm" target="_blank">AC- Pro Trip Calculator</a></li>
          ...
          <h2>&nbsp;</h2>
            ...
            <p>
           	<ul>
                	<li><a href="downloads/Richards/Richards_313np-manual-im1223-001b.pdf" target="_blank">Network Protector Instruction Manual - Type 313NP / 800 to 3500 Amperes</a></li>
                	<li><a href="downloads/Richards/137npManual-IM1224-001B.pdf" target="_blank">Network Protector Instruction Manual - Type 137NP / 800 to 3500 Amperes</a></li>
                	<li><a href="downloads/Richards/147npManual-IM1225-001B.pdf" target="_blank">Network Protector Instruction Manual - Type 147NP / 2250 to 4500 Amperes</a></li>
                	<li><a href="downloads/Richards/MN120501.pdf" target="_blank">Network Protector 2250A: MN120501</a></li>
                	<li><a href="downloads/Richards/LLFKAFuseCharacteristic.pdf" target="_blank">LLFKA Fuse Characteristic</a></li>
                	<li><a href="downloads/Richards/LimiterFuseCurve.jpg" target="_blank">Limiter Fuse Curve</a></li>
                	<li><a href="downloads/Richards/312-1206-20.pdf" target="_blank">Base Terminal w/ Top Terminal (4 holes): P/N 312-1206-20</a></li>
                	<li><a href="downloads/Richards/DOC080411.pdf" target="_blank">DOC080411</a></li>
                	<li><a href="downloads/Richards/AlloyFuseCurves_WH.pdf" target="_blank">Alloy Fuse Curves - Westinghouse Electric</a></li>
            </ul>
            </p>
          <h2>&nbsp;</h2>
          ...
          <h2>&nbsp;</h2>
            <h2>Patrick Enterprises</h2>
            <p>
           	<ul>
                	<li><a href="downloads/RenewalParts_GEF-4628B_PDF.pdf" target="_blank">Renewal Parts: GE 8000</a></li>
            </ul>
            </p>
          </div>
